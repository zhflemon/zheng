...
/**
 * oss测试 Created by shuzheng on 2017/4/18.
 */
@Controller
@RequestMapping("/demo")
public class DemoController extends BaseController {
	...
	public String upload1() {
		...
		PutObjectResult putObjectResult = aliyunOssClient.putObject(OssConstant.ALIYUN_OSS_BUCKET_NAME, "text.txt",
	...
	public String upload2() throws FileNotFoundException {
		...
		@SuppressWarnings("unused")
		PutObjectResult putObjectResult = aliyunOssClient.putObject(OssConstant.ALIYUN_OSS_BUCKET_NAME, "file.png",
				file);
		return "success";
	}
