...
public class AESUtil {
	...
	public static String aesEncode(String content) {
		try {
			...
			// Library，重新编译后就一切正常了。
			// String aesEncode = new String(new
			// BASE64Encoder().encode(byteAES));
			String aesEncode = new String(Base64.encodeBase64(content.getBytes("UTF-8")), "UTF-8");
			// 11.将字符串返回
			return aesEncode;
	...
	public static String aesDecode(String content) {
		try {
			...
			byte[] byteContent = Base64.decodeBase64(content.getBytes("UTF-8"));
			/*
			 * 解密
			 */
